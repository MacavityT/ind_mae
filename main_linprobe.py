...
def get_args_parser():
    ...
    parser.add_argument(
        ...
        default=False,
        help=
        'Enabling distributed evaluation (recommended during training for faster monitor'
    )
...
def main(args):
    ...
    dataset_train = IndustryFinetuneDataset(root=args.data_path,
                                            img_prefix=args.img_prefix,
                                            ann_file='train.txt',
                                            is_train=True,
                                            transform=transform_train)
    dataset_val = IndustryFinetuneDataset(root=args.data_path,
                                          img_prefix=args.img_prefix,
                                          ann_file='val.txt',
                                          is_train=False,
                                          transform=transform_val)
